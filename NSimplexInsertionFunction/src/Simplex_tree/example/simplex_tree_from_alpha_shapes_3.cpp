...
#ifdef DEBUG_TRACES
				std::cout << "vertex [" << the_alpha_shape_vertex->point() << "] not found - insertNSimplex " << vertex << std::endl;
#endif // DEBUG_TRACES
...
#endif // DEBUG_TRACES
		simplex_tree.insertNSimplex(the_simplex_tree, std::sqrt(*the_alpha_value_iterator));
