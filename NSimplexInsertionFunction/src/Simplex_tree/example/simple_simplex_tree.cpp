...
int main (int argc, char * const argv[])
{
	...
	typePairSimplexBool returnValue =
			simplexTree.insertNSimplex ( firstSimplex.first, firstSimplex.second );
	...
	returnValue =
			simplexTree.insertNSimplex ( secondSimplex.first, secondSimplex.second );
	...
	returnValue =
			simplexTree.insertNSimplex ( thirdSimplex.first, thirdSimplex.second );
	...
	returnValue =
			simplexTree.insertNSimplex ( fourthSimplex.first, fourthSimplex.second );
	...
	returnValue =
			simplexTree.insertNSimplex ( fifthSimplex.first, fifthSimplex.second );
	...
	returnValue =
			simplexTree.insertNSimplex ( sixthSimplex.first, sixthSimplex.second );
	...
	returnValue =
			simplexTree.insertNSimplex ( seventhSimplex.first, seventhSimplex.second );
	...
	returnValue =
			simplexTree.insertNSimplex ( eighthSimplex.first, eighthSimplex.second );
	...
	returnValue =
			simplexTree.insertNSimplex ( ninethSimplex.first, ninethSimplex.second );
	...
	returnValue =
			simplexTree.insertNSimplex ( tenthSimplex.first, tenthSimplex.second );
	...
	returnValue =
			simplexTree.insertNSimplex ( eleventhSimplex.first, eleventhSimplex.second );
