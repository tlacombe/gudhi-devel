...
int main(int argc, char *argv[]) {
  ...
  double radius_1 = 1e20;
  ANN_ngbh_graph ngbh_graph(point_cloud.begin(), point_cloud.end(), point_dimension, radius_1);
  ...
  for (auto point_iterator = point_cloud.begin(); point_iterator < point_cloud.end(); point_iterator++) {
    ...
    cout << ngbh_graph.get_num_neighbors(point_iterator, radius_2) << " neighbors in a ball of radius " << radius_2 << endl;
  }
  cout << endl;
  ...
  for (auto point_iterator = point_cloud.begin(); point_iterator < point_cloud.end(); point_iterator++) {
    ...
    int nb_points = ngbh_graph.get_neighbors_dist_r(point_iterator, radius_3, ndist);
    cout << "Point [" << point_iterator->first_3_cordinates() << "] - closest neighbors, in a ball of radius ";
    cout << radius_3 << ", distances are:";
