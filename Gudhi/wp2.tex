...
neighbour relations. As yet, no algorithm has been proposed which is
based on a simple perturbation of a fixed set of themselves.

The underlying problem is that the metric definining the triangulation
is not Euclidean.  In order to strengthen the theoretical
foundations for tackling  these issues,
% foundations of anisotropic meshing of
% Euclidean domains, and of meshing general Riemannian manifolds, 
we intend to develop a deeper understanding of the Delaunay complex
...
quite restrictive) conditions under which the witness complex, the
...
sufficient precision, more light-weight representations may be
...
inference algorithms discussed in Focus Area 3. In particular,
