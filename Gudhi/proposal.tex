...
The Gudhi project addresses four main scientific challenges~: {\em choosing the right representation, bypassing the curse of dimensionality, searching for stable models, and turning theory into practice.} We now present the state of the art and the scientific strategy of our project.
We identify four main scientific objectives~:  to develop {\em scalable representations} of shapes  in the form of {\em simplicial complexes};
...
bottleneck.}  %A major part of the effort will be devoted to the development of.
