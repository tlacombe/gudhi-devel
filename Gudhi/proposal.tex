...
% Our project departs from the techniques The last decade has seen tremendous progress in  the understanding of geometry in high-dimensional spaces.
...
%A major part of the effort will be devoted to the development of.

%To address those challenges, we will %focus our research on four areas.
...
%  The Gudhi project  intends to develop {\em scalable representations} of shapes  in the form of {\em simplicial complexes}
% which are expressive and powerful representations. We will then design  {\em
% practical algorithms} to approximate {\em highly nonlinear shapes}. We will also provide robust algorithms  to
...
% we will produce data structures and algorithms that are sensitive to the intrinsic dimension, and
% will {\em break the current computational
...
rather than  routine automation at large scales.%, fast and robust data processing.
...
{\bf Objective 4 :}   {\em To devise an open source {\em  software platform for geometric understanding in high dimensions}. %that will provide the software environment for experimenting with our new data structures and algorithms and to integrate them in a coherent library of interoperable modules. 
