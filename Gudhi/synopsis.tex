...
% New techniques are Such manifolds may be highly nonlinear with a non trivial topology, and new techniques must be explored to 
%  {\em Data
...
Emblematic problems such as mesh generation and surface reconstruction in 3-dimensions are now well-understood and several provably correct and highly efficient solutions are  available~\cite{geometrica-ecg-book}. 
...
Attempts to analyze higher dimensional shapes led to the development of beautiful pieces of theory with deep roots in various areas of mathematics like Riemannian geometry, geometric measure theory, differential and algebraic topology. Let us mention the emergence of a sampling theory of geometric objects, and of geometric inference~\cite{geometrica-ccl09}, and the emergence and rapid growth of persistent homology~\cite{eh-ph-2008} and topological data analysis~\cite{gc-td-2009}.  These advances attracted interest from several fields like biological data analysis~\cite{fpgo-airc-2009} % , computer vision~\cite{cids-lbsni-2008} 
or sensor networks~\cite{rg-bptd-2008}, and led to a new startup company, co-founded by G. Carlsson, a mathematician from Stanford university (\url{(http://www.ayasdi.com/}{}).  However, until now, the applications have been limited to rather simple cases and to low dimensions.

% , offering homology based products
% for interactive visualization and topological data analysis of data sets in high dimension,
% has even recently been launched by Gunnar Carlsson,
% one of the pioneer researcher in the field of topological data analysis and persistent homology).

% A startup
% %G. Carlsson, a mathematician from Stanford university, recently cofounded a 
% company that  offers homology based products 
% for interactive visualization and topological data analysis (\url{http://www.ayasdi.com/}{}). 
...
Geometrica has been at the cutting edge of research in geometric data
...
\bibitem[Carlsson, 2009]{gc-td-2009}
Carlsson, G. (2009).
\newblock Topology and data.
\newblock {\em Bull. Amer. Math. Soc., 46}, pages 255--308.
\vspace{-2mm}
...
\newblock AMS.%merican Mathematical Society.
\vspace{-2mm}
