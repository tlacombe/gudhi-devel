...
An open question is to establish bounds on the minimal size of data structures encoding simplicial complexes. Another major question is to design succinct data structures
