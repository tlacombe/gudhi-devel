...
This data structure already represents a significant leap forward from the state of the art. It desrves further analysis and optimisation, and continued research is expected to yield encodings capable of sizes orders of magnitude higher still.
