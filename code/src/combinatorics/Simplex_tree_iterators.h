...
#include "boost/iterator/iterator_facade.hpp"
 ...
 /** \brief Iterator over the vertices of a simplex
                           ...
                           , typename SimplexTree::Vertex >  
  {
    ...
    bool operator==(const Simplex_vertex_iterator &other)
    { return (sib_ == other.sib_ && v_ == other.v_); }
    bool operator!=(const Simplex_vertex_iterator &other)
    { return (sib_ != other.sib_ || v_ != other.v_); }
    Simplex_vertex_iterator& operator++()
    { if(sib_ != NULL) {
        v_ = sib_->parent(); sib_ = sib_->oncles(); }
      return *this; }
    Simplex_vertex_iterator operator++(int)
    {Simplex_vertex_iterator tmp(*this); operator++();
      return tmp;}    
                                  ...
                                  >
{
  ...
  mutable Simplex_handle            sh_     ; //current Simplex_handle in the boundary
                                  ...
                                  >
{
 ...
 private:
  ...
  Simplex_handle& dereference () const { return sh_; }
