...
BOOST_AUTO_TEST_CASE(Distance_to_measure_test)
{	    
    std::vector< std::vector< double > > point_cloud = 
	{ {0,1}, {0.1986693308,0.9800665778}, {0.3894183423,0.921060994}, {0.5646424734,0.8253356149},
	{0.7173560909,0.6967067093}, {0.8414709848,0.5403023059}, {0.932039086,0.3623577545}, {0.98544973,0.1699671429},
	...
	Gudhi::Topological_inference_with_cubical_complexes::Euclidean_distance_to_measure cgal_dtm_2( point_cloud , 2 );
	Gudhi::Topological_inference_with_cubical_complexes::Euclidean_distance_to_measure cgal_dtm_3( point_cloud , 3 );
	Gudhi::Topological_inference_with_cubical_complexes::Euclidean_distance_to_measure cgal_dtm_4( point_cloud , 4 );
	Gudhi::Topological_inference_with_cubical_complexes::Euclidean_distance_to_measure cgal_dtm_5( point_cloud , 5 );
	Gudhi::Topological_inference_with_cubical_complexes::Euclidean_distance_to_measure cgal_dtm_6( point_cloud , 6 );
	
	typedef Gudhi::Topological_inference_with_cubical_complexes::Euclidan_distance_squared Euclidean_distance_squared;
	Euclidean_distance_squared eu;
	Gudhi::Topological_inference_with_cubical_complexes::General_distance_to_measure< Euclidean_distance_squared > dtm_2( point_cloud , eu , 2 );
	Gudhi::Topological_inference_with_cubical_complexes::General_distance_to_measure< Euclidean_distance_squared > dtm_3( point_cloud , eu , 3 );
	Gudhi::Topological_inference_with_cubical_complexes::General_distance_to_measure< Euclidean_distance_squared > dtm_4( point_cloud , eu , 4 );
	Gudhi::Topological_inference_with_cubical_complexes::General_distance_to_measure< Euclidean_distance_squared > dtm_5( point_cloud , eu , 5 );
	Gudhi::Topological_inference_with_cubical_complexes::General_distance_to_measure< Euclidean_distance_squared > dtm_6( point_cloud , eu , 6 );
	
	std::vector< std::vector<double> > test_points = {
	{0.3062377223,0.5719554243},{0.7394391091,0.1487249169},{0.373517605,0.7417548236},{0.5315839334,0.0021610181},
	{0.1758711033,0.3609837494},{0.9865298271,0.6795099119},{0.6360497079,0.3373212365},{0.5284706799,0.3174959824},
	{0.0409378991,0.870356309},{0.2329443775,0.9568689389},{0.7044924865,0.7515483499},{0.0008099666,0.0548141315},
	{0.2470970738,0.0179793842},{0.4011810031,0.8768032524},{0.4769931401,0.4780828904},{0.114431405,0.3043775395},
	{0.1204834331,0.9677960016},{0.5151430287,0.6474383404},{0.3226383415,0.6976743154},{0.733299084,0.839971099},
	{0.3515931142,0.5033381311},{0.4967946296,0.4534695961},{0.2696601092,0.7782530268},{0.4936982493,0.1646357717},
	{0.6725589952,0.8686557822},{0.8214133284,0.0263267304},{0.6150923725,0.7037107446},{0.6322422659,0.5217748405},
	{0.3587157459,0.0620461269},{0.3424729586,0.0845390505},{0.7857448668,0.4398536868},{0.4055592958,0.1778881876},
	{0.6411314437,0.5034874689},{0.5652040292,0.0567098504},{0.5634029156,0.9896501263},{0.2366014519,0.9828308369},
	{0.1118361729,0.3850893194},{0.5678213176,0.5671542366},{0.435422678,0.7096097104},{0.2441710602,0.6313142052},
	{0.0858207154,0.4513712451},{0.5396328357,0.2888388762},{0.3200314057,0.2491604781},{0.6787462735,0.8976919239},
	{0.9116505212,0.6066012431},{0.8038593007,0.8923540865},{0.7545569851,0.5109277265},{0.2123381682,0.6524164705},
	{0.8388417866,0.7966891695},{0.5906320098,0.449229724},{0.9260707975,0.2667917667},{0.5298315589,0.0749084977},
	{0.5116266906,0.8032039402},{0.0667892119,0.4620025163},{0.9963911234,0.3290697813},{0.1651197276,0.8597706431},
	{0.806939306,0.1898783606},{0.9178122345,0.0734515248},{0.0313638567,0.8557117416},{0.3554281814,0.4816394448},
	{0.3692226945,0.0640287518},{0.7342943654,0.1781992286},{0.0806389498,0.6532333957},{0.6824206091,0.3840367373},
	{0.2564511311,0.9237950186},{0.8460988342,0.5084707434},{0.8859092279,0.9449019369},{0.1307898168,0.4496689783},
	{0.2313242506,0.2754965944},{0.9733985423,0.0825102995},{0.4851177461,0.351291022},{0.6553498053,0.6475509556},
	{0.5485326254,0.7999800958},{0.911057251,0.5849064724},{0.6180408113,0.3644694223},{0.1211599549,0.3434267985},
	{0.9895424731,0.3776550766},{0.1318662849,0.102953949},{0.261131197,0.5978131867},{0.5021086256,0.5418606063},
	{0.7424264466,0.647401311},{0.7329491484,0.6338511785},{0.6058896955,0.7432181661},{0.9152317925,0.9942577351},
	{0.6837563259,0.7803902924},{0.0368969014,0.4339055878},{0.8672499477,0.5268352935},{0.0610160942,0.9585187214},
	{0.6882211105,0.642159981},{0.1624938902,0.339284525},{0.9355663352,0.4077336108},{0.0151397293,0.7193772714},
	{0.8352605756,0.5166272039},{0.6865356863,0.1179786108},{0.3576263792,0.2348050226},{0.7378599446,0.8233386483},
	{0.0899504519,0.0252832524},{0.548621618,0.576205929},{0.6573415778,0.9560035556},{0.3897021806,0.3737198533},
	{0.0604918115,0.0854136308},{0.3857464832,0.1762845335},{0.6800860818,0.9170418205},{0.4862177377,0.3111076169},
	{0.0665568728,0.4319956601},{0.9474420971,0.2490432977},{0.042145832,0.9982053456},{0.0876164774,0.4267241016},
	{0.5414825641,0.1538707432},{0.4996793361,0.5371069221}
	};	
	
	double epsilon = 0.0000001;
	for ( size_t i = 0 ; i != test_points.size() ; ++i )
	{		
		BOOST_CHECK( fabs( cgal_dtm_2( test_points[i] ) - dtm_2( test_points[i] ) ) <= epsilon );
		BOOST_CHECK( fabs( cgal_dtm_3( test_points[i] ) - dtm_3( test_points[i] )) <= epsilon );
		BOOST_CHECK( fabs( cgal_dtm_4( test_points[i] ) - dtm_4( test_points[i] )) <= epsilon );
		BOOST_CHECK( fabs( cgal_dtm_5( test_points[i] ) - dtm_5( test_points[i] )) <= epsilon );
		BOOST_CHECK( fabs( cgal_dtm_6( test_points[i] ) - dtm_6( test_points[i] )) <= epsilon );
	} 	
