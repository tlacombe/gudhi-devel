...
#ifndef SIMPLEX_TREE_FIXED_DIMENSION_ITERATOR_H_
#define SIMPLEX_TREE_FIXED_DIMENSION_ITERATOR_H_
...
class Simplex_tree_fixed_dimension_iterator : public boost::iterator_facade<
    Simplex_tree_fixed_dimension_iterator<SimplexTree>,
...
// any end() iterator
  Simplex_tree_fixed_dimension_iterator()
      : sib_(nullptr),
        st_(nullptr),
        dim_skel_(0),
        curr_dim_(0) {
  ...
  Simplex_tree_fixed_dimension_iterator(SimplexTree * st, int dim_skel)
      : sib_(nullptr),
        st_(st),
        dim_skel_(dim_skel),
        curr_dim_(0) {
...
// valid when iterating along the SAME boundary.
  bool equal(Simplex_tree_fixed_dimension_iterator const& other) const {
...
#endif  // SIMPLEX_TREE_FIXED_DIMENSION_ITERATOR_H_
