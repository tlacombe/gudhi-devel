...
int main(int argc, char* argv[]) {
  ...
  clock_t start, end;
  {
    ...
    std::cout << "     Compute the star of every simplex in the Simplex_tree:" << std::endl;
    start = clock();
    ...
    std::cout << "        Total time for computation = " << static_cast<double>(end - start) / CLOCKS_PER_SEC
              << " s. \n";
    std::cout << "        Average time per simplex = "
              << (static_cast<double>(end - start) / CLOCKS_PER_SEC) / (double)opt_st.num_simplices() << " s. \n";
  }
  std::cout << std::endl;
  {
    // Construct the Simplex Tree
    ...
    std::cout << "        Total time for computation = " << static_cast<double>(end - start) / CLOCKS_PER_SEC
              << " s. \n";
    std::cout << "        Average time per simplex = "
              << (static_cast<double>(end - start) / CLOCKS_PER_SEC) / (double)brut_st.num_simplices() << " s. \n";
  }
