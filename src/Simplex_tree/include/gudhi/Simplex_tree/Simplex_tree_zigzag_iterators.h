          ...
          , boost::forward_traversal_tag >
{
  public:
                               ...
                               , int                         dim_max )
    {
      ...
      dim_max_                = dim_max;
      // num_E                   = zigzag_edge_filtration_->size();
      // curr_edg = 1;
    ...
    void increment() 
    {
      ...
      if(sh_it_ == partial_zzfil_.end())
      {
        ...
        { // The simplices in partial_zzfil_ come by decreasing keys, hence 
          //are all maximal when removing from left to right. Additionally, we 
          //want to maintain the validity of Simplex_handle (i.e. map 
...
/* Dimension maximal of the flag complex. */
  int                                                                 dim_max_;
