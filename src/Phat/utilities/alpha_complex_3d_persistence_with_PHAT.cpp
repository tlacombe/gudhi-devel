...
int main(int argc, char * const argv[]) {
  ...
  Gudhi::phat_interface::Compute_persistence_with_phat< ST > phat(&simplex_tree); 
  ...
  out_file << argv[1] << ".pers";
  Gudhi::phat_interface::write_intervals_to_file_Gudhi_format(persistence,out_file.str().c_str());
