...
def test_check_computations_of_maxima_and_norms:
    ...
    second = gudhi.PersistenceLandscapesOnGrid(file_with_intervals="data/file_with_diagram_2", grid_min_=0., grid_max_=1., number_of_points_=100)
