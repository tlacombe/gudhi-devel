...
def check_sortev_vector_distances_template(): 
...
def check_distance_computations():
	p = gudhi.PersistenceVectors(file_with_intervals="data/file_with_diagram", where_to_cut=100);  
...
def check_default_parameters_of_distances():
